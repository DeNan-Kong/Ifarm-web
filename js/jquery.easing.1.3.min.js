jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
	...
	easeInElastic: function(n, e, t, r, u) {
		...
		return -(s * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * (e * u - a) * Math.PI / i)) + t
	},
	easeOutElastic: function(n, e, t, r, u) {
		...
		return s * Math.pow(2, -10 * e) * Math.sin(2 * (e * u - a) * Math.PI / i) + r + t
	},
	easeInOutElastic: function(n, e, t, r, u) {
		...
		if(i || (i = .3 * u * 1.5), s < Math.abs(r)) {
			s = r;
			var a = i / 4
		} else var a = i / (2 * Math.PI) * Math.asin(r / s);
		return 1 > e ? -.5 * s * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * (e * u - a) * Math.PI / i) + t : s * Math.pow(2, -10 * (e -= 1)) * Math.sin(2 * (e * u - a) * Math.PI / i) * .5 + r + t
	},
	...
	easeOutBounce: function(n, e, t, r, u) {
		return(e /= u) < 1 / 2.75 ? 7.5625 * r * e * e + t : 2 / 2.75 > e ? r * (7.5625 * (e -= 1.5 / 2.75) * e + .75) + t : 2.5 / 2.75 > e ? r * (7.5625 * (e -= 2.25 / 2.75) * e + .9375) + t : r * (7.5625 * (e -= 2.625 / 2.75) * e + .984375) + t
	},
